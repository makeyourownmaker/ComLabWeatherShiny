...
# On 20 August 2012, a cottonwood seed stuck in the sensor area (protective caps) and moved around by the wind caused erroneous precipitation 
# readings before 2:26 PM.
...
# The remaining data should contain no missing values but other issues may remain such as long series of repeated values.
